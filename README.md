...
- Toolkit berisi Programming, Frontend, Backend, Database, AI & ML, Tools, dan Dev Tools. Programming mencakup JavaScript, Python, PHP, C#, dan C++; Frontend mencakup HTML, CSS, Bootstrap, dan React. AI & ML mencakup Claude, Claude Code, DeepSeek, Gemini, ChatGPT, Codex, Python, NumPy, dan Jupyter Notebook. Tools berisi Figma, VS Code, Canva, Word, Excel, dan PowerPoint. Setiap item memiliki logo berukuran besar, tanpa tombol tambahan pada kartu.
